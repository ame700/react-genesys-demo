...
function getSavedAuthData(): SavedAuthData | undefined {
  const authData = '{"accessToken":"1t_VlLWafLe9-4cwoxFXoj_61Ee6d3Zde1jVAOppbUguw5t35FSiq6zIMNCKJKGFrD5a66zsoP40QFF8Pwancw","envKey":"pca-us"}';
  if (authData) {
    try {
